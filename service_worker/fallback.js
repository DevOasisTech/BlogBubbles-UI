...
//   console.log("--------------Highlight selection1 start--------------",identifier);

//   let nodePaths = identifier["nodePaths"];
...
//   let currentNodePath = nodePaths[currentLevel];
...
//     }
//     let nextNodePath = nodePaths[currentLevel - 1];
//     let nextElement = currentElement.childNodes[nextNodePath.prevSiblingCount];
//     currentElement = nextElement;
//     currentLevel--;
//   }
//   let selectionNodeData = identifier["selectionNodeData"];
//   let startOffset = selectionNodeData.anchorOffset
//   let endOffset = selectionNodeData.focusOffset
